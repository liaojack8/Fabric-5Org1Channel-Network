...
switch (arg) {
    ...
    case 'add' : invokeAdd(process.argv[3],process.argv[4],process.argv[5],process.argv[6]); break;
...
async function invokeAdd(data1,data2,data3,data4) {
...
module.exports = { queryFind , invokeAdd }